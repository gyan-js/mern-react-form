...
class Form extends Component {
    ...
    onSubmit(e) {
        ...
        axios.post('http://localhost:4000/app/signup', credentials)
                        ...
                        <div className='flex flex-col drop-shadow-md form  max-w-[448px] w-[100%]  p-[30px] pb-[48px] '>
                            <form >
                                <div className='field pb-[24px] flex flex-col '>
                                    ...
                                    <input onChange={this.changeName} value={this.state.fullName} className='text-[16px] leading-[24px] min-h-[44px] rounded-[4px] outline-none border-none px-3 w-[380px]' maxLength="200" required placeholder='Enter your full name' />
                                </div>
                                <div className='field pb-[24px] flex flex-col '>
